...
$(function(){
  ...
  $('.about').click(function(){
    ...
    $('.backbtn').attr('class', 'backbtn');
    $('#songwrap').append('<div class="about-text">we\'re roseay <br>we\'re leading the war against robots,<br>robots who decide what music we listen to<br>join the human music movement!<br><br><strong>submitting</strong><br><br>1. <strong>you</strong> post a song (anyone can post) <br><br>2. the song instantly goes onto everyone\'s list <br><br> 3. people vote it up!<br><br><br><br><br><strong>listening</strong><br><br>1. click that play button up there</div>')
